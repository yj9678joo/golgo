...
export function NicknamePage() {
  ...
  return (
    <MobilePage contentClassName="flex max-w-[430px] flex-col justify-center">
      <div className="rounded-lg border border-border bg-card p-4 shadow-sm min-[375px]:p-5">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="text-sm font-semibold text-primary">계정 설정</p>
            <h1 className="mt-3 text-[22px] font-semibold leading-tight min-[375px]:text-2xl">
              닉네임을 확인해 주세요
            </h1>
          </div>
          <button
            className="inline-flex size-11 shrink-0 items-center justify-center rounded-md border border-border text-muted-foreground hover:bg-muted"
            type="button"
